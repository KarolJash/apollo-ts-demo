...
export const createAuthorMutationResolver: GraphQLFieldResolver<unknown, IApolloServerContext> = async (
  _source,
  { input: { username } },
  _context,
  _info
...
const createAuthorMutation: GraphQLFieldConfig<unknown, IApolloServerContext> = {
